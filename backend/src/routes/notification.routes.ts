...
router.get('/project/:projectId/settings', authenticate, asyncHandler(async (req: Request, res: Response) => {
...
router.put('/project/:projectId/settings', authenticate, asyncHandler(async (req: Request, res: Response) => {
  const { projectId } = req.params;
  const userId = req.user!.userId;
...
router.post('/project/:projectId/test', authenticate, asyncHandler(async (req: Request, res: Response) => {
  const { projectId } = req.params;
